...
function Navbar() {
  ...
  />
        ...
        <div className="hidden lg:flex items-center gap-10 text-[17px] font-medium text-black">
          ...
          {/* Book Now Button */}
          <button className="relative overflow-hidden bg-[#962a27] text-white px-6 py-3 rounded-full font-medium group transition-all duration-300 hover:scale-105">
      ...
      {menuOpen && (
        ...
        <div className="lg:hidden absolute top-[100px] right-6 w-[220px] bg-white rounded-3xl shadow-2xl border border-[#f1e4d8] py-6 px-5 flex flex-col gap-5 z-50 animate-[fadeIn_.3s_ease]">
          ...
          <button
            onClick={() => setMenuOpen(false)}
            className="bg-[#962a27] text-white py-3 rounded-full mt-2 hover:scale-105 duration-300"
          >
            Book Now
          </button>
