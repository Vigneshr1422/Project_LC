...
const AdminDashboard = () => {
  ...
  /* =========================
      DASHBOARD BUTTONS (Added Date Card)
  ========================== */
  const dashboardButtons = [
    {
      icon: <Calendar size={34} />, // 👈 ✅ NEW: Date button setup added first
      title: "Date",
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] px-5 py-8 md:px-10 md:py-10">
      {/* TOP */}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 max-w-5xl mx-auto">
        {dashboardButtons.map((item, index) => (
          <button
            ...
            className="bg-white border border-gray-200 rounded-[30px] p-5 md:p-8 flex flex-col items-center justify-center text-center hover:border-[#962a27] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer"
          >
            {/* ICON BOX */}
            <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-gradient-to-br from-[#fff1f1] to-[#ffe3e2] flex items-center justify-center text-[#962a27] shadow-sm">
              {item.icon}
            </div>
      ...
      <div className="mt-16 flex justify-center">
        <button
          ...
          className="flex items-center gap-3 bg-[#962a27] text-white px-8 py-4 rounded-2xl font-semibold hover:scale-105 hover:bg-[#b23835] transition-all duration-300 cursor-pointer"
        >
          <LogOut size={20} />
          Logout
        </button>
