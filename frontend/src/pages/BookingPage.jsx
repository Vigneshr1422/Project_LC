          ...
          {step === 5 && formData.bookingType === "Package" && (
            <div className="animate-fadeIn px-2 sm:px-0">
                    ...
                    {availablePackages.map((pkg) => (
                      ...
                      >
                        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-12 gap-0">
                          ...
                          <div className="md:col-span-1 lg:col-span-6 p-5 sm:p-6 flex flex-col justify-between border-b md:border-b-0 md:border-r border-gray-100">
                            <div>
                          ...
                          <div className="md:col-span-1 lg:col-span-3 bg-gray-50/50 p-5 sm:p-6 flex flex-col justify-center items-stretch text-center">
                            <div>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-1 gap-2.5 mt-5 sm:mt-6">
                              <button
                                onClick={() => setSelectedPkgForModal(pkg)}
                                className="w-full border border-gray-300 bg-white text-gray-700 rounded-xl py-3 font-bold text-xs sm:text-sm hover:bg-gray-50 transition-colors shadow-sm"
                              >
                                View Full Menu
                              </button>
                              <button
                                onClick={() => handleChange("selectedPackageId", pkg.id)}
                                className={`w-full py-3 rounded-xl text-white font-bold text-xs sm:text-sm transition-all shadow-sm ${
              ...
              <div className="sticky bottom-4 mt-8 z-40">
                <div className="bg-white border border-gray-200/80 shadow-xl rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-4">
                  <div className="text-center sm:text-left">
          ...
          {step === 6 && (
            <div className="animate-fadeIn">
              ...
              <div className="bg-white border border-gray-200 rounded-[32px] overflow-hidden shadow-sm">
                <div className="bg-[#962A27] text-white p-6">
              ...
              <div className="flex flex-col sm:flex-row justify-between gap-4 mt-8">
                <button onClick={prevStep} className="border border-gray-300 px-8 py-4 rounded-2xl font-semibold hover:bg-gray-50">
                  ← Back
                </button>
                ...
                >
                  ...
                  <span className="text-xl font-light tracking-widest transition-transform group-hover:translate-x-1">→</span>
                </button>
              </div>
            </div>
          )}
