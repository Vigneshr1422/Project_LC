  ...
  if (error && !storage) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-6 text-center">
        ...
        <button onClick={fetchStorage} className="bg-[#962a27] text-white px-6 py-3 rounded-xl font-bold shadow-lg shadow-red-900/20 active:scale-95 transition-all cursor-pointer"> Retry Pipeline Connection </button>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto relative z-10 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-2 text-left">
          <div>
            ...
            <h1 className="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight"> Storage Control Center </h1>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/80 border border-white backdrop-blur-md rounded-3xl p-6 sm:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] relative overflow-hidden text-left transition-all hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                ...
                <div className="bg-slate-900 px-4 py-2 rounded-2xl border border-slate-800 shadow-sm self-start sm:self-auto flex items-center gap-2">
                  {isCritical ? (
            ...
            <div className="bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] text-white border border-slate-800 rounded-3xl p-6 sm:p-7 shadow-xl relative overflow-hidden text-left group">
              <div className="absolute right-0 bottom-0 transform translate-x-8 translate-y-8 text-slate-800/20 pointer-events-none group-hover:scale-105 transition-transform duration-500">
                <Activity size={180} />
              </div>
              
              <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-2">
                  <span className="bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 text-[10px] font-black tracking-widest uppercase px-2.5 py-1 rounded-lg">
                    Cluster Health Index
                  </span>
                  <h3 className="text-lg sm:text-xl font-extrabold text-white tracking-tight">
                    Database Utilization & Space Summary
                  </h3>
                  <p className="text-slate-300 font-medium text-xs sm:text-sm max-w-lg leading-relaxed">
